      ...
      <div className="container mx-auto py-6">
        <div className="flex flex-col xl:flex-col gap-[30px]">
          ...
          <div className="flex-1 flex items-start xl:justify-start mb-8 xl:mb-0">
            <ul className="flex flex-col md:flex-row xl:flex-row gap-10">
              {info.map((item, index) => (
                <li key={index} className="flex items-center gap-6">
                  <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] shadow-md bg-secondary text-accent rounded-md flex items-center justify-center">
          ...
          {/* form */}
          <div className="xl:h-[54%] shadow-md rounded-md">
            <form
